...
required_files = [
    ...
    "debounce_top/debounce_top.sv",
    "debounce/sim.tcl",
    "debounce/sim.png",
    "debounce_top/sim.tcl",
    "debounce_top/fpga.png",
]
...
def main():
    ...
    tester = test_suite_320.build_test_suite_320(
        assignment_path, start_date="03/10/2025"
    )
    tester.add_required_tracked_files(required_files)
    tester.add_makefile_rule("sim_tb", "debounce", ["debounce.sv"], ["work/sim_tb.log"])
    tester.add_build_test(
        repo_test.FileRegexCheck(
            tester,
            "debounce/work/sim_tb.log",
            "Simulation done, WAIT_TIME_US=50 with 0 errors",
            "Debounce Testbench Test",
    ...
    tester.add_makefile_rule(
        "synth",
        "debounce_top",
        ["../debounce/debounce.sv", "debounce_top.sv"],
