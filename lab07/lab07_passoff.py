...
def main():
    ...
    tester.add_required_tracked_files(
        ["seven_segment4.sv", "ssd_top.sv", "multisegment_FDCE_0.png"]
    )
    tester.add_Makefile_rule(
        "sim_multisegment", ["seven_segment4.sv"], ["sim_multisegment.log"]
    )
    tester.add_build_test(
        repo_test.FileRegexCheck(
            tester,
            "sim_multisegment.log",
            "ERROR",
    ...
    tester.add_Makefile_rule(
        "synth",
        ["seven_segment4.sv", "ssd_top.sv"],
        ["synthesis.log", "multisegment_synth.dcp"],
    )
    tester.add_Makefile_rule(
        "implement",
        ["multisegment_synth.dcp"],
        [
            "implement.log",
            "multisegment.bit",
            "multisegment.dcp",
