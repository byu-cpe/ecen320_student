...
def main():
    ...
    tester.add_build_test(
        repo_test.FileRegexCheck(
            tester,
            "sim_debounce.log",
            "Simulation done, WAIT_TIME_US=5000 with 0 errors",
    ...
    tester.add_Makefile_rule(
        "sim_debounce_50", ["debounce.sv"], ["sim_debounce_50.log"]
    )
    tester.add_build_test(
        repo_test.FileRegexCheck(
            tester,
    ...
    tester.add_Makefile_rule(
        "synth",
        ["debounce.sv", "debounce_top.sv"],
        ["synthesis.log", "debounce_top_synth.dcp"],
    )
    tester.add_Makefile_rule(
        "implement",
        ["debounce_top_synth.dcp"],
        [
            "implement.log",
            "debounce_top.bit",
            "debounce_top.dcp",
