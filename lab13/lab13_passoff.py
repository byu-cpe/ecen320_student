...
def main():
    tester = test_suite_320.build_test_suite_320(
        "lab13", max_repo_files=30, start_date="04/7/2025"
    )
    ...
    tester.add_Makefile_rule(
        "sim_tb_codebreaker", ["codebreaker.sv"], ["sim_tb_codebreaker.log"]
    )
    tester.add_build_test(
        repo_test.file_regex_check(
            "sim_tb_codebreaker.log",
    ...
    tester.add_Makefile_rule(
        "synth",
        ["codebreaker.sv", "codebreaker_top.sv"],
        ["synthesis.log", "codebreaker_top_synth.dcp"],
    )
    tester.add_Makefile_rule(
        "implement",
